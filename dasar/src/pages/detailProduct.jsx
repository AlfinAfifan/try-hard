  ...
  return (
    <div className="w-100 min-h-screen flex justify-center items-center bg-slate-200">
      {Object.keys(product).length > 0 && (
        <div className="flex font-sans max-w-3xl bg-white rounded-lg overflow-hidden">
          ...
          <form className="flex-auto p-6">
            ...
            <div className="flex items-baseline mt-4 mb-6 pb-6 border-b border-slate-200 ">{product.description}</div>
